...
KureselHaberler mobil uygulaması için, RSS haberlerini **Gemini** ile özgün cümlelerle yeniden yazıp
...
2. `scripts/generate-feed.mjs`:
   ...
   - önceki `docs/haberler.json`'da olmayan (en fazla 10) yeni haberi Gemini ile yeniden yazar,
...
RSS'i çeker ama hiçbir haberi yeniden yazmaz (Gemini olmadan içerik yayınlanmaz — telif riskini
